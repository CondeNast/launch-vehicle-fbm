...
describe('router', () => {
  ...
  describe('onMessage message router', function () {
    ...
    it('emits "message" event', () => {
      ...
      router.onMessage(messenger, event);
    });
    ...
    it('emits "text" event', () => {
      ...
      router.onMessage(messenger, event, fakeSession);
    });
    ...
    it('emits "greeting" event', () => {
      ...
      router.onMessage(messenger, event, session);
    });
    ...
    it('emits "greeting" event when provided a pattern', () => {
      ...
      router.onMessage(myMessenger, event, session);
    });
    ...
    it('emits "text" event for greeting when emitGreetings is disabled', () => {
      ...
      router.onMessage(myMessenger, event, {});
    });
  ...
  describe('onPostback', function () {
    ...
    it('emits postback event', () => {
      ...
      router.onPostback(messenger, event);
    });
  });
